...
#define HAVE_WINSOCK2_H					1		//windows	socket2
#define HAVE_POLL_H						0
#define HAVE_CLOSESOCKET				1
#define fork GetCurrentProcessId
#define open _open
#define close _close
#define chdir _chdir
#define atoll atol
...
#include "../inc/libavformat/ffm.h"
#include "../inc/libavformat/network.h"
#include "../inc/libavformat/os_support.h"
#include "../inc/libavformat/rtpdec.h"
#include "../inc/libavformat/rtsp.h"
#include "../inc/libavformat/avio_internal.h"
//////#include "../inc/libavformat/internal.h"
#include "../inc/libavformat/url.h"

#include "../inc/libavutil/avassert.h"
#include "../inc/libavutil/avstring.h"
#include "../inc/libavutil/lfg.h"
#include "../inc/libavutil/dict.h"
#include "../inc/libavutil/mathematics.h"
#include "../inc/libavutil/random_seed.h"
...
static int http_server(void)
{
    ...
    if(!(poll_table = (pollfd *)av_mallocz((nb_max_http_connections + 2)*sizeof(*poll_table)))) {
...
static int handle_connection(HTTPContext *c)
{
    ...
    case RTSPSTATE_WAIT_REQUEST:
        ...
        /* read the data */
    read_loop:
        len = recv(c->fd,(char *) c->buffer_ptr, 1, 0);
        if (len < 0) {
    ...
    case RTSPSTATE_SEND_PACKET:
        ...
        if (!(c->poll_entry->revents & POLLOUT))
            return 0;
        len = send(c->fd,(const char *) c->packet_buffer_ptr,
...
static IPAddressACL* parse_dynamic_acl(FFStream *stream, HTTPContext *c)
{
    ...
    acl = (IPAddressACL *)av_mallocz(sizeof(IPAddressACL));
...
static int http_parse_request(HTTPContext *c)
{
    ...
    if (extract_rates(ratebuf, sizeof(ratebuf),(const char *) c->buffer)) {
    ...
    if (c->post) {
        ...
        if (!stream->is_feed) {
            ...
            if (client_id && extract_rates(ratebuf, sizeof(ratebuf),(const char *) c->buffer)) {
                HTTPContext *wmpc;
    ...
    q = (char *)c->buffer + strlen((const char *)c->buffer);
...
static int http_prepare_data(HTTPContext *c)
{
    ...
    case HTTPSTATE_SEND_DATA_HEADER:
        ...
        c->fmt_ctx.streams = (AVStream **)av_mallocz(sizeof(AVStream *) * c->stream->nb_streams);
        ...
        redo:
            ...
            if (ret < 0) {
                ...
                if (c->first_pts == AV_NOPTS_VALUE) {
                    c->first_pts = av_rescale_q(pkt.dts, c->fmt_in->streams[pkt.stream_index]->time_base, temp_AV_TIME_BASE_Q);
                    c->start_time = cur_time;
                }
                ...
                send_it:
                    ...
                    if (c->is_packetized) {
                        ...
                        c->cur_pts = av_rescale_q(pkt.dts, ist->time_base, temp_AV_TIME_BASE_Q);
                        c->cur_pts -= c->first_pts;
                        c->cur_frame_duration = av_rescale_q(pkt.duration, ist->time_base, temp_AV_TIME_BASE_Q);
                        /* find RTP context */
...
static int http_receive_data(HTTPContext *c)
{
    ...
    while (c->chunked_encoding && !c->chunk_size &&
        ...
        if (len < 0) {
            ...
            c->chunk_size = strtol((const char *)c->buffer, 0, 16);
    ...
    if (c->buffer_end > c->buffer_ptr) {
        len = recv(c->fd, (char *)c->buffer_ptr,
                                   ...
                                   struct in_addr my_ip)
{
 ...
 sdp_done:
    ...
    return strlen((const char *)*pbuffer);
}
...
static AVStream *add_av_stream1(FFStream *stream, AVCodecContext *codec, int copy)
{
    ...
    if (copy) {
        ...
        if (codec->extradata_size) {
            fst->codec->extradata = (uint8_t *)av_malloc(codec->extradata_size);
    ...
    for(;;) {
        ...
        if (!av_strcasecmp(cmd, "Port")) {
            ...
            if (stream || feed) {
                ...
                feed = (FFStream *)av_mallocz(sizeof(FFStream));
            ...
            if (feed) {
                ...
                feed->child_argv[i] = (char *)av_malloc(30 + strlen(feed->filename));
            ...
            if (stream || feed) {
                ...
                FFStream *s;
                stream = (FFStream *)av_mallocz(sizeof(FFStream));
...
//                audio_enc.quality = atof(arg) * 1000;
            ...
            if (stream || feed || redirect) {
                ...
                redirect = (FFStream *)av_mallocz(sizeof(FFStream));
