...
#include "../inc/libavutil/eval.h"
#include "../inc/libavutil/dict.h"
#include "../inc/libavutil/opt.h"
#include "../inc/libavutil/intfloat.h"
#include "../inc/compat/va_copy.h"
#include "cmdutils.h"
//#include "version.h"
#if CONFIG_NETWORK
...
#if CONFIG_OPENCL
#include "../inc/libavutil/opencl.h"
#endif
                         ...
                         const char *arg)
{
    ...
    GROW_ARRAY(l->groups, OptionGroup *, l->nb_groups);
                    ...
                    const char *key, const char *val)
{
    ...
    GROW_ARRAY(g->opts, Option *, g->nb_opts);
...
static void expand_filename_template(AVBPrint *bp, const char * p_template,
                                     struct tm *tm)
{
    int c;
...
void *grow_array(void * arg_array, int elem_size, int *size, int new_size)
{
    ...
    if (*size < new_size) {
        uint8_t *tmp = av_realloc(arg_array, new_size*elem_size);
        if (!tmp) {
