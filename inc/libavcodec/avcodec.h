...
typedef struct AVCodecContext {
     ...
     */
    struct AVCodecInternal *pinternal;
...
typedef struct AVCodecDefault {		//internal.h
    const char *key;		//const uint8_t *key;
    const char *value;		//const uint8_t *value;
}AVCodecDefault;
